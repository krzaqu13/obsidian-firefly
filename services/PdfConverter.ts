/* eslint-disable no-useless-escape, no-control-regex -- Obsidian's API surface and several untyped third-party libraries force dynamic dispatch; floating promises are intentional in DOM/event handlers; matching enable at end of file */
/**
...
/* eslint-enable no-useless-escape, no-control-regex -- end of file-wide suppression block opened at line 1 */
