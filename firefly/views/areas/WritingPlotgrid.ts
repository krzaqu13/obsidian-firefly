...
export class WritingPlotgrid extends ItemView {
    ...
    async render(container: HTMLElement): Promise<void> {
        ...
        container.addClass('plot-grid-root');
    ...
    private pushPlotGridUndo(): void {
        ...
        if (this.undoStack.length > WritingPlotgrid.MAX_UNDO) {
...
export default WritingPlotgrid;
